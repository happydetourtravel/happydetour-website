        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <p style={{
                ...
                Solo travelers are absolutely welcome! These rates include the drink package so you can enjoy your vacation worry-free.
              </p>
              ...
              <div style={{
                ...
                {[
                  { type: "Interior", price: "$1,497" },
                  { type: "Ocean View", price: "$1,777" },
                  { type: "Balcony", price: "$1,777" }
                ].map((cabin, index) => (
                  <div key={index} style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Cruising with a partner, friend, or family member? Here's pricing per person when you book for two, drink package included.
            </p>
            ...
            <div style={{
              ...
              {[
                { type: "Interior", price: "$1,694" },
                { type: "Ocean View", price: "$1,974" },
                { type: "Balcony", price: "$1,994" }
              ].map((cabin, index) => (
                <div key={index} style={{
                  background: '#F9FAFB',
                  padding: '1.5rem',
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.borderColor = '#007298';
                  e.currentTarget.style.transform = 'translateY(-2px)';
                }}
                onMouseOut={(e) => {
