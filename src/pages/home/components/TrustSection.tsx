...
export default function TrustSection() {
  return (
    <section id="trust" aria-labelledby="trust-heading" className="bg-stone-50 py-20 sm:py-28 border-t border-stone-100">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <ScrollReveal direction="up" delay={0} duration={680}>
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            <h2 id="trust-heading" className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-amber-100 aspect-[3/4] w-full max-w-xs mx-auto lg:mx-0">
                <img
                  ...
                  alt="Eric Carney, Happy Detour Travel advisor, smiling with a client"
              ...
              <div className="rounded-2xl bg-white border border-gray-100 px-5 py-4 flex items-center gap-4 max-w-xs mx-auto lg:mx-0 w-full">
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-amber-100 shrink-0" aria-hidden="true">
                  <i className="ri-user-smile-line text-amber-600 text-base" aria-hidden="true" />
                </div>
                <div>
              ...
              <div className="rounded-2xl bg-white border border-gray-100 px-5 py-4 flex items-center gap-3 max-w-xs mx-auto lg:mx-0 w-full">
                <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-stone-100" aria-hidden="true">
                  <i className="ri-award-line text-stone-500 text-base" aria-hidden="true" />
                </div>
                <div>
              ...
              {TRUST_POINTS.map((point, i) => (
                <ScrollReveal key={point.title} direction="left" delay={160 + i * 100} duration={680}>
                  <div className="flex gap-5 rounded-2xl border border-gray-100 bg-white p-5 hover:border-amber-200 transition-colors duration-200">
                    <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-amber-50 border border-amber-100 text-amber-600 shrink-0 mt-0.5" aria-hidden="true">
        ...
        <ScrollReveal direction="up" delay={300} duration={680}>
          <div className="mt-16 pt-10 border-t border-stone-200">
            ...
            <ul className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3" aria-label="Travel brands and partners">
              {PARTNERS.map((partner) => (
                ...
                >
                  <div className="w-8 h-8 flex items-center justify-center text-amber-500" aria-hidden="true">
                    <i className={`${partner.icon} text-xl`} aria-hidden="true" />
                  </div>
